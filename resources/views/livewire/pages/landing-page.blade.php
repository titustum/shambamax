...
<div>
                        ...
                        <form action="#" method="GET" class="sm:flex">
                            <div class="w-full sm:max-w-xs">
                                ...
                                <input type="text" name="equipment" id="equipment"
                                    class="block w-full rounded-md border-gray-300 py-3 px-4 placeholder-gray-500 shadow-sm focus:border-green-600 focus:ring-2 focus:ring-green-600"
                                    placeholder="Search for equipment...">
                            </div>
                            <button type="submit"
                                class="mt-3 w-full rounded-md border border-transparent bg-green-600 py-3 px-4 font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0">
                                Search
                            </button>
                        </form>
                    </div>
    ...
    <section class="bg-white py-16 sm:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="mt-3 text-xl text-gray-500 sm:mt-4">Connecting farmers and equipment owners in three easy
                    steps</p>
            </div>
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                    <!-- Step 1 -->
                    <div
                        class="text-center bg-gray-50 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
                        ...
                        <p class="mt-2 text-base text-gray-500">Browse our extensive catalog of agricultural machinery
                    ...
                    <div
                        ...
                        <p class="mt-2 text-base text-gray-500">Reserve the equipment you need for the dates you require
                            and make secure payments through our platform.</p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="mt-2 text-base text-gray-500">Collect the equipment, use it for your farming needs,
            ...
            <div class="mt-12 border-t border-gray-200 pt-8">
                <p class="text-center text-base text-gray-400">
                    Want to list your equipment? <a href="#"
                        class="font-medium text-green-600 hover:text-green-500">Learn how to become a provider</a>
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-16 grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-4">
                ...
                @foreach ($categories as $category)
                    <!-- Tractors Category -->
                    <div
                        class="group relative overflow-hidden rounded-lg bg-gray-200 shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
                        <img src="{{ asset('images/tractor.avif') }}" alt="Tractor"
                            class="h-full w-full object-cover object-center group-hover:opacity-75">
                        <div
                            class="absolute inset-0 flex flex-col items-center justify-center bg-gray-800 bg-opacity-50 text-white text-center p-4">
                            <h3 class="text-lg font-medium">{{ $category->name }}</h3>
                            <p class="mt-1 text-sm">{{ $category->equipment->count() }}+ available</p>
                        </div>
                    </div>
                @endforeach
                <!-- View All Category -->
                <div class="relative overflow-hidden rounded-lg bg-green-100 shadow-lg transition-shadow duration-300 ease-in-out group hover:shadow-xl">
                    <!-- Overlay and Content -->
                    <div class="absolute inset-0 flex flex-col items-center justify-center bg-gray-800 bg-opacity-60 text-white text-center p-6">
                        <h3 class="text-xl font-semibold">View All Categories</h3>
                        <p class="mt-2 text-sm">Discover a variety of equipment categories to fit your needs.</p>
                        <a href="/categories" class="mt-4 inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white font-medium rounded-md transition-colors duration-200">Explore</a>
                    </div>
                </div>
    ...
    <section class="bg-white py-12 sm:py-16 lg:py-20">
        <div class="mx-auto container px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="mt-3 text-xl text-gray-500 sm:mt-4">Discover agricultural equipment in your area ready for use
                </p>
            </div>
            ...
            <div class="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                ...
                <!-- View All Card -->
                <div
                    class="group relative flex items-center justify-center overflow-hidden rounded-lg bg-green-100 shadow-md hover:bg-green-200 transition-all duration-300">
                    <a href="{{ route('all.equipment') }}" class="p-6 text-center">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                    <div class="flex items-center mb-4">
                        <img src="https://randomuser.me/api/portraits/men/91.jpg" width="60" height="60"
                            alt="John Muthomi, Meru County" class="w-12 h-12 rounded-full mr-4">
                        <div>
                            <h3 class="font-semibold text-lg">John Muthomi</h3>
                            <p class="text-gray-600">Meru County</p>
                        </div>
                    </div>
                    <p class="text-gray-700 mb-4">"ShambaMax has been a game-changer for my small farm. I was able to
                        rent a tractor during the planting season, which helped me prepare my land in half the time it
                        usually takes. This year, I've seen a 30% increase in my maize yield!"</p>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                    <div class="flex items-center mb-4">
                        <img src="https://randomuser.me/api/portraits/women/36.jpg" width="60" height="60"
                            alt="Grace Otieno, Kisumu County" class="w-12 h-12 rounded-full mr-4">
                        <div>
                            <h3 class="font-semibold text-lg">Grace Otieno</h3>
                            <p class="text-gray-600">Kisumu County</p>
                        </div>
                    </div>
                    <p class="text-gray-700 mb-4">"As a small-scale rice farmer, I never thought I'd be able to afford a
                        combine harvester. Thanks to ShambaMax, I rented one for my harvest season. It not only saved me
                        time but also reduced post-harvest losses. My profits have increased by 40%!"</p>
                    <div class="flex items-center">
                        <!-- Star Rating -->
                        <svg class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                    <div class="flex items-center mb-4">
                        <img src="https://randomuser.me/api/portraits/men/80.jpg" width="60" height="60"
                            alt="David Kimani, Nakuru County" class="w-12 h-12 rounded-full mr-4">
                        <div>
                            <h3 class="font-semibold text-lg">David Kimani</h3>
                            <p class="text-gray-600">Nakuru County</p>
                        </div>
                    </div>
                    <p class="text-gray-700 mb-4">"ShambaMax has transformed how I manage my dairy farm. I rented a
                        milking machine, which has improved the hygiene and efficiency of my milking process. My milk
                        production has increased by 25%, and I'm now able to meet the demands of larger buyers in my
                        area."</p>
                    <div class="flex items-center">
                        <!-- Star Rating -->
                        <svg class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"
            ...
            <div class="text-center mt-8">
                <a href="/success-stories"
                    class="bg-green-800 text-white py-2 px-4 rounded-lg hover:bg-green-700 transition-colors duration-300">View
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <!-- Benefit 1 -->
                <div
                    class="text-center bg-green-50 p-6 rounded-lg shadow-md transition-transform transform hover:scale-105">
                    <div class="bg-green-100 rounded-full p-6 inline-block mb-4">
                        <svg class="w-12 h-12 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg" aria-label="Cost-Effective">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    ...
                    <div class="bg-green-100 rounded-full p-6 inline-block mb-4">
                        <svg class="w-12 h-12 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg" aria-label="Verified Equipment">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    ...
                    <div class="bg-green-100 rounded-full p-6 inline-block mb-4">
                        <svg class="w-12 h-12 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg" aria-label="Boost Productivity">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    ...
                    <div class="bg-green-100 rounded-full p-6 inline-block mb-4">
                        <svg class="w-12 h-12 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg" aria-label="Community Support">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <section class="py-20 bg-green-600">
        <div class="container mx-auto px-4 text-center">
            ...
            <a href="#"
                class="bg-white text-green-600 py-3 px-8 rounded-lg text-lg font-semibold hover:bg-green-100 transition duration-300">
                Sign Up Now
            </a>
        </div>
    </section>
